			...
			<div class="frst_nav_container">
				...
				<div class="contact_header_container">
					...
					<div class="head_div head_div3">
						<p>CONTACT US<br>
						<span><a href="contactus.php#section5">Write us a message</a></span></p>
					</div>
				</div>
			...
			<div class="second_nav_background">
				...
				<div class="second_nav_container">
					...
					<ul class="menu">
			            ...
			            <li class="item button"><a href="quote.php#section5">Get Quote</a></li>
		...
		<main>
			<div class="services_bg">
				...
				<div class="banner_container">
						<div class="banner_content">
							...
							<a href="quote.php#section5"> <button> Get Quote</button></a>
							</div>
						</div>
					</div>
			</div>
			...
			<div class="services_background_container">
				...
				<div class="container_header">
						...
						<div class="container_header_bg">
							...
							<div class="container_header_contact">
								...
								<p>Need Help?</p>
								<p>Email us : <a href="#">info@rocklandsecurity.ca</a></p>
								<p>Call us : <a href="#">(7778)-700-4146</a></p>
				...
				<div class="services_container">
					...
					<div class="services_gallery_container div_one">

						<div class="gallery_content_container">

							<div>
								<img src="images/gallery/sample.png">
							</div>
							...
							<div>
								...
								consequat.</p>
								<p><a href="quote.php#section5"> <button>Get Quotation</button></a></p>
							</div>							

						</div>

						<div class="gallery_content_container div_two">
							...
							<div>
								<p>SUPERVISORY & SUPPORT STRUCTURE</p>
								<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
								tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
								quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
								consequat.</p>
						...
						<div class="gallery_content_container div_three">
					...
					<div class="services_gallery_container">

						<div class="gallery_content_container div_one">
					...
					<div class="services_gallery_container services_gallery_container1">
					...
					<div class="content3_wrapper">
						...
						<div>
						<p>hire us today. Call Us <a href="tel:778-700-4146">(778)-700-4146</a></p>
						
						<p>we offer wide array of services and a HIGH QUALITY PRIVATE SECURITY GUARD & PATROL SERVICES IN BRITISH COLUMBIA!</p>
						</div>
